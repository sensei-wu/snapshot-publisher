...
public class FavouriteColourApp {
    ...
    public static void main(String[] args) {
        ...
        usersAndColours.to("favorite-color-intermed");

        // step 2 - we read that topic as a KTable so that updates are read correctly
        KTable<String, String> usersAndColoursTable = builder.table("favorite-color-intermed");
        ...
        favouriteColours.to(Serdes.String(), Serdes.Long(),"favorite-color-output");
